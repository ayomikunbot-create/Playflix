...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "PLAYFLIX — Stream & Download in 3D" },
      { name: "description", content: "Stream and download movies, series, K-drama, cartoons and live sports in immersive 3D on PLAYFLIX." },
      { property: "og:title", content: "PLAYFLIX — Stream & Download in 3D" },
      { property: "og:description", content: "Movies, series, K-drama, cartoons & live sports — all in one immersive 3D streaming experience." },
    ],
  }),
  component: Index,
});
